...
export default function Home() {
  return (
    <div className='pb-1 bg-offWhite-200'>
      <Head>
      ...
      <main className='bg-offWhite-200 px-10 md:px-20 lg:px-40'>
        <section className='min-h-screen'>
          ...
          <dev className="text-center p-10">
            ...
            <p className='text-md py-5 leading-2 text-gray-800 mx-auto max-w-4xl md:text-lg lg:text-xl lg:leading-8'>
        ...
        <section>
          <div className='py-8'>
            <div className='shadow-lg rounded-lg p-5 bg-offWhite-100'>
          ...
          <div className='xl:flex gap-10 justify-center'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 bg-offWhite-100'>
              <div className='flex justify-center'><Image src={code} width={100} height={100} /></div>
              <h3 className='text-lg font-bold pt-8 pb-2'>Languages/Tools That I Use</h3>
              <p className='text-gray-800 py-2'><spam className='text-teal-600'>Programming languages:</spam> C/C++, Python, Java</p>
              <p className='text-gray-800 py-2'><spam className='text-teal-600'>Markup languages:</spam> LaTex, Markdown</p>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 bg-offWhite-100 xl:max-w-md'>
              <div className='flex justify-center'><Image src={design} width={100} height={100} /></div>
              <h3 className='text-lg font-bold pt-8 pb-2'>Project: Kanban To-Do App</h3>
              ...
              <p className='text-gray-800 py-1'>CustomTkinter</p>
              <p className='text-gray-800 py-1 pb-5'>PyInstaller</p>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 bg-offWhite-100 xl:max-w-md' >
              ...
              <h3 className='text-lg font-bold pt-8 pb-2'>Project: Path Finding</h3>
              ...
              <h4 className='text-teal-600'>tools I use</h4>
              <p className='text-gray-800 py-1 pb-9'>C++</p>

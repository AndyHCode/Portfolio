...
export default function Home() {
  ...
  return (
    ...
    <div className='pb-1 bg-offWhite-200 dark:bg-offDark-200'>
      <Head>
      ...
      <main className='bg-offWhite-200 px-10 md:px-20 lg:px-40 dark:bg-offDark-200'>
        <section className='min-h-screen'>
          <nev className="py-10 mb-12 flex justify-between">
            <h1 className='text-xl font-mono font-bold dark:text-offWhite-100'>Andy Huang</h1>
            <ul className='flex items-center'>
              <li><BsFillMoonStarsFill onClick={()=>{setDarkMode(!darkMode)}} className='cursor-pointer text-xl dark:text-offWhite-100' /></li>
          ...
          <dev className="text-center p-10">
            <h2 className='text-6xl py-2 text-teal-600 font-semibold md:text-7xl lg:text-8xl dark:text-teal-500 font-something'>Andy Huang</h2>
            <h3 className='text-2xl py-2 md:text-3xl lg:text-4xl dark:text-offWhite-100'>Computer Science Student at Wayne State</h3>
            <p className='text-md py-5 leading-2 text-gray-800 mx-auto max-w-4xl md:text-lg lg:text-xl lg:leading-8 dark:text-offWhite-100'>
        ...
        <section>
          ...
          <div className='xl:flex gap-10 justify-center'>
            <div className='text-center shadow-lg p-10 rounded-xl my-10 bg-offWhite-100 dark:bg-offDark-100 dark:text-offWhite-100'>
            ...
            <div className='text-center shadow-lg p-10 rounded-xl my-10 bg-offWhite-100 xl:max-w-md dark:bg-offDark-100 dark:text-offWhite-100'>
